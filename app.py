...
st.set_page_config(page_title="💧 Water Usage Predictor (CNN + LSTM)", layout="wide")
st.title("💧 AI-based Smart Water Usage Prediction")
...
st.success(f"💧 Predicted next-day water usage: **{predicted_usage:.2f} liters**")
